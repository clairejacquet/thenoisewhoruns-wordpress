<?php
update_option( 'siteurl', 'http://thenoisewhoruns.com' );
update_option( 'home', 'http://thenoisewhoruns.com' );
/**
 ...
 */
 wp_enqueue_script('macytest', 'https://cdn.jsdelivr.net/npm/macy@2', null, null,  true);
...
function simple_persona_scripts() {
	...
	wp_enqueue_style( 'bootstrap', '/wp-content/themes/draco/assets/css/bootstrap-grid.css', true );
	// wp_enqueue_style( 'main', '/wp-content/themes/draco/assets/css/main.css', true );
	wp_enqueue_style( 'custom-main', '/wp-content/themes/simple-persona/assets/css/custom-styles.css', true );
	...
	// wp_enqueue_script('fontawesome', 'https://kit.fontawesome.com/ad28620b89.js', [], '1.0', true);
	wp_enqueue_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js', null, null, true );
	wp_enqueue_script( 'vuejs', 'https://cdn.jsdelivr.net/npm/vue@2.6.11', null, null, true );
	// wp_enqueue_script('macy', 'https://cdn.jsdelivr.net/npm/macy@2', null, null,  true);
	wp_enqueue_script('vue', '/wp-content/themes/simple-persona/assets/js/vue.js', [], '1.0', true);
	wp_enqueue_script('main', '/wp-content/themes/simple-persona/assets/js/main.js', [], '1.0', true);
